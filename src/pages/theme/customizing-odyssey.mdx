...
title: Customizing Genesee Ewery 
description: Learn how to customize Genesee Ewery's theme styles.
---

This is one of the core features of Genesee Ewery Theme and we've made it super easy to make the overall look and feel of the site your own with just a few top-level CSS custom properties. These custom properties and demo themes will be found in the `theme.css` file under `src/styles/`.
...
```js
export default {
  title: `Genesee Ewery Theme | A Marketing Website Theme for Startups and Businesses`,
...
You'll notice a lot of rounded corners on the Genesee Ewery Theme but if you look closely when the "Dark" theme is enabled the corners are all hard edges. This is because of the global `--theme-shape-radius` property. It will determine the shape of things like cards and images.
