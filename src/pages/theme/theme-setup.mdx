...
title: Theme Setup
description: Learn how to setup Genesee Ewery's seo, logo, favicon, nav items, etc.
---
...
```js
export default {
  title: `Genesee Ewery Theme | A Marketing Website Theme for our business`,
  description: `A forward thinking agrivoltaic farming operation.`,
  url: `https://barbadosblackbellysheep.biz`, // No trailing slash!
  name: `Genesee Ewery`, // The short name of the business or brand name. Used for things like the copyright in the footer.
...
```astro
<p class="ewery-logo">Genesee Ewery</p>
...
The easiest way to swap out the Genesee Ewery logo across the site is to replace this code with the SVG code for your company's logo or using an `<img>` tag linked to your company logo.

You should see that the Genesee Ewery logo changes across the theme once this is updated.
...
export const footerSocials = [
  ...
  {
    url: 'https://github.com/littlesticksdev/theme',
    icon: githubIcon,
  },
];
```
...
Genesee Ewery Theme will automatically generate a `sitemap.xml` file for you using Astro's `@astrojs/sitemap` integration. 
...
export default defineConfig({
  site: 'https://theme.sapling.supply/',
