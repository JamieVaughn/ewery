...
excerpt: 'This is a sample blog post for the Genesee Ewery Theme. If an excerpt is provided it will appear in the preview.'
tags: ['Remote Work']
---

import {YouTubeEmbed} from '@components/theme'
